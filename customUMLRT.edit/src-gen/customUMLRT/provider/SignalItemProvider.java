...
/**
 * This is the item provider adapter for a {@link customUMLRT.Signal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SignalItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						CustomUMLRTPackage.Literals.SIGNAL__NAME, true, false, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Signal_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Signal_type_feature", "_UI_Signal_type"),
						CustomUMLRTPackage.Literals.SIGNAL__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Signal_type")
	...
	public void notifyChanged(Notification notification) {
		...
		case CustomUMLRTPackage.SIGNAL__NAME:
		case CustomUMLRTPackage.SIGNAL__TYPE:
