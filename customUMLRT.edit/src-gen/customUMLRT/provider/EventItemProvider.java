...
/**
 * This is the item provider adapter for a {@link customUMLRT.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addWcetPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_wcet_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_wcet_feature", "_UI_Event_type"),
						CustomUMLRTPackage.Literals.EVENT__WCET, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CustomUMLRTPackage.Literals.EVENT__SEND_SIGNALS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Event_type") + " " + event.getWcet();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CustomUMLRTPackage.Literals.EVENT__SEND_SIGNALS,
				CustomUMLRTFactory.eINSTANCE.createsendSignal()));
	}
