...
/**
 * This is the item provider adapter for a {@link customUMLRT.Trigger} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriggerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Trigger_port_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Trigger_port_feature", "_UI_Trigger_type"),
						CustomUMLRTPackage.Literals.TRIGGER__PORT, true, false, true, null, null, null));
	}
	...
	protected void addSignalPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Trigger_signal_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Trigger_signal_feature",
								"_UI_Trigger_type"),
						CustomUMLRTPackage.Literals.TRIGGER__SIGNAL, true, false, true, null, null, null));
	}
