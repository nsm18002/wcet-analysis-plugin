...
/**
 * This is the item provider adapter for a {@link customUMLRT.Protocol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProtocolItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Protocol_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Protocol_name_feature",
								"_UI_Protocol_type"),
						CustomUMLRTPackage.Literals.PROTOCOL__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CustomUMLRTPackage.Literals.PROTOCOL__SIGNALS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case CustomUMLRTPackage.PROTOCOL__NAME:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case CustomUMLRTPackage.PROTOCOL__SIGNALS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CustomUMLRTPackage.Literals.PROTOCOL__SIGNALS,
				CustomUMLRTFactory.eINSTANCE.createSignal()));
	}
