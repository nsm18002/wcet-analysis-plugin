...
/**
 * This is the item provider adapter for a {@link customUMLRT.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						CustomUMLRTPackage.Literals.PORT__NAME, true, false, false,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Port_kind_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Port_kind_feature", "_UI_Port_type"),
						CustomUMLRTPackage.Literals.PORT__KIND, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addConjugatedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Port_conjugated_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Port_conjugated_feature", "_UI_Port_type"),
						CustomUMLRTPackage.Literals.PORT__CONJUGATED, true, false, false,
	...
	protected void addProtocolPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Port_protocol_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Port_protocol_feature", "_UI_Port_type"),
						CustomUMLRTPackage.Literals.PORT__PROTOCOL, true, false, true, null, null, null));
	}
