 ...
 * </p>
 * <ul>
 *   <li>{@link customUMLRT.impl.ConnectorImpl#getPort <em>Port</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConnectorImpl extends MinimalEObjectImpl.Container implements Connector {
	...
	protected EClass eStaticClass() {
		return CustomUMLRTPackage.Literals.CONNECTOR;
	}
	...
	public EList<Port> getPort() {
		if (port == null) {
			port = new EObjectResolvingEList<Port>(Port.class, this, CustomUMLRTPackage.CONNECTOR__PORT);
		}
		return port;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CustomUMLRTPackage.CONNECTOR__PORT:
			return getPort();
		}
